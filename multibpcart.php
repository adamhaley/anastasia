...
class multibpcart
{
    ...
    public $shipping;
    public function multibpcart($sfile, $products, $co, $post_vars, $get_vars, $session_vars = '')
    {
    ...
    public function get_unique_bps($products)
    {
    ...
    public function get_products_by_bpname($products, $bpname)
    {
        $retarray = array();
        for($i=0;$i<count($products);$i++) {
...
<!--<input type=\"button\" value=\"Continue Shopping\" onClick=\"window.close()\">-->
    ...
    public function view_full_cart()
    {
        $products = $this->products;
    ...
    public function view_checkout_step_1()
    {
        $co = $this->co;
...
<input type=\"submit\" value=\"Submit Order\"> <input type=\"reset\" value=\"Clear Form\" >
    ...
    public function view_checkout_step_2()
    {
        $post_vars = $this->post_vars;
    ...
    public function view_checkout_step_3()
    {
    ...
    public function process_credit_card($num)
    {
    ...
    public function log_order($details)
    {
        $co = $this->co;
    ...
    public function instantiate_bp($bpname)
    {
