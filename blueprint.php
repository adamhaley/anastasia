...
class blueprint
{
    ...
    public function get_all_elements($params = array())
    {
    ...
    public function get_all_elements_xml($params = array())
    {
    ...
    public function sql_from_params($params)
    {
        if(!is_array($params)) {
            $params = array();
        }
