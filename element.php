...
class element
{
    ...
    public function set_prop($prop, $value, $http_vars=array(), $keywords='', $post_files=array())
    {
    ...
    public function get_prop_for_web($prop)
    {
    ...
    public function set_all($post_vars, $post_files = array())
    {
        $http_vars = $post_vars;
        $bp = $this->bp;
    ...
    public function populate_from_profile($profile)
    {
