...
class db
{
    ...
    public function db($user='', $pass='', $database='')
    {
        $this->host = 'localhost';
        $this->user = $user;
        $this->password = $pass;
    ...
    public function generate_from_blueprint($bp)
    {
    ...
    public function populate_bps($bparray)
    {
    ...
    public function value_exists($table, $field, $value)
    {
