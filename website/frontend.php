...
class frontend
{
    public function frontend($sfile, $request_uri, $get_vars, $post_vars, $session_vars = '', $dynstatic='')
    {
        $this->sfile = $sfile;
    ...
    */
    ...
    public function parse_and_replace($code, $eobj)
    {
        //recursively parse all elinks
        ...
        } elseif(strstr($code, "<%bp_slideshow%>")) {
    ...
    public function parse_elinks($e)
    {
        $bp = $e->bp;
    ...
    public function wrap_in_main($pagecode, $tid='')
    {
    ...
    public function call_frontend_functions($code)
    {
    ...
    public function navlet($i)
    {
        ...
        } elseif(preg_match("/linkto:/", $thispage->get_prop('content'))) {
    ...
    public function _get_page_array()
    {
        $p = new pages();
        $parray = $p->get_all_elements(array('post' => '1','nav' => '1','order_by'=>'seq'));
        return $parray;
    }
    public function get_bp_obj()
    {
    ...
    public function display_by_cat($cat)
    {
        return "override me!\n<br>";
    }

    public function slideshow($e)
    {
        $get_vars = $this->get_vars;
        $href = new href('');
    ...
    public function bp_slideshow($params='')
    {
    ...
    public function bp_slideshow_byid($params='')
    {
    ...
    public function frontend_final_stuff($code)
    {
