...
class href
{
    public function href($codedstring, $dynfile='')
    {
    ...
    public function get_dynamic_href($relabsolute='', $codedstring='')
    {
    ...
    public function querystring_from_coded_string($string='')
    {
    ...
    public function codedstring_from_querystring($querystring)
    {

    }

    public function get_static_href($relabsolute='', $codedstring='')
    {
        $relabsolute = $relabsolute ? $relabsolute : 'relative';
        if($relabsolute == 'absolute') {
            $l = $this->local;
    ...
    public function get_static_from_dynamic($uri, $relabsolute='')
    {
        $ua = explode("?", $uri);
    ...
    public function get_array_from_coded_string($string='')
    {
        $string = $string ? $string : $this->codedstring;
    ...
    public function get_coded_string_from_array($array)
    {
        reset($array);
