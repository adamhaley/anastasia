...
class elink extends element
{
    ...
    public function display()
    {
        ...
        for($i=0;$i<count($elements);$i++) {
            ...
            if($source = $tobj->get_prop('html_source')) {
                $h->template = $source;
            } elseif($template=$tobj->get_prop('html')) {
    ...
    public function get_element_objects($cond = array())
    {
