...
class cart
{
    ...
    public function cart($sfile, $bp, $products, $co, $post_vars, $get_vars, $session_vars = '')
    {
...
<input type=\"submit\" value=\"Submit Order\"> <input type=\"reset\" value=\"Clear Form\" >
    ...
    public function mail_order($ordernum)
    {
        $co = $this->co;
        $products = $this->products;
